...
export function TrainerMentorFormClient() {
  ...
  return (
    <form onSubmit={onSubmit} className="overflow-hidden rounded-3xl border border-black/10 bg-white shadow-sm">
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="grid gap-6">
          <div>
            <p className="text-sm font-semibold text-[var(--rma-ink)]">Contact</p>
            <p className="mt-1 text-xs leading-5 text-black/50">
              Provide details we can use to follow up.
            </p>
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <label className="text-sm font-semibold text-[var(--rma-ink)]">
                ...
                <input
                  ...
                  placeholder="e.g. Lusaka, Copperbelt, Zambia"
                />
              </label>

              <label className="text-sm font-semibold text-[var(--rma-ink)] sm:col-span-2">
                LinkedIn (optional)
                <input
                  className={inputClass}
                  value={linkedinUrl}
                ...
                return (
                  <label
                    ...
                    className={[
                      ...
                      checked
                        ? "border-[color:var(--rma-green)]/30 bg-[color:var(--rma-green)]/6"
          ...
          <div>
            <p className="text-sm font-semibold text-[var(--rma-ink)]">Background</p>
            <p className="mt-1 text-xs leading-5 text-black/50">
              Help us understand your experience and how you work with SMEs.
            </p>
            <div className="mt-4 grid gap-4">
              <label className="text-sm font-semibold text-[var(--rma-ink)]">
                Experience summary <span className="text-[color:var(--rma-orange)]">*</span>
                <textarea
                  className="mt-2 min-h-[170px] w-full resize-y rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm text-[var(--rma-ink)] outline-none shadow-sm transition focus:border-[color:var(--rma-blue)]/40 focus:ring-4 focus:ring-[color:var(--rma-blue)]/15"
                  value={experience}
